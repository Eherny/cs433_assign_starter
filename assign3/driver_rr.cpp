/**
 * Driver (main) program for RR scheduling algorithm.
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Author: Eric Hernandez and Christopher Mead" << std::endl;     // TODO: add your name
    std::cout << "Date: 03/29/2023" << std::endl;               // TODO: add date
    ...
    SchedulerRR scheduler (time_quantume);
    // Run the scheduler
